...
///
/// The current OID is for **testing purposes only**. It will be replaced before the next
/// release.
///
/// https://yossarian.net/junk/oids/
pub(crate) const ML_KEM_768_SEED_EXTENSION_OID: &[u64] = &[1, 3, 6, 1, 4, 1, 55738, 666, 5];
